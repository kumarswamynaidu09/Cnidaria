...
export const MatchDetailView: React.FC<MatchDetailViewProps> = ({
  ...
  if (!selectedResult) {
    return (
      ...
      >
        <div className="w-16 h-16 rounded-2xl bg-deep-violet border border-hot-pink/15 flex items-center justify-center text-hot-pink mb-4">
        ...
        <p className="font-body-md text-sm text-lavender leading-relaxed mb-6">
          Please choose a match from the results grid first.
        </p>
        <button
          onClick={onBack}
          className="px-6 py-2.5 rounded-xl bg-deep-violet hover:bg-hot-pink hover:text-deep-midnight border border-hot-pink/20 text-hot-pink font-sans text-xs font-semibold cursor-pointer transition-transform active:scale-95"
        >
          Back to matches
        </button>
      </div>
  ...
  return (
    ...
    >
      ...
      >
        <button
          onClick={onBack}
          className="group inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-deep-violet/30 hover:bg-deep-violet/75 border border-hot-pink/10 hover:border-hot-pink/25 text-lavender hover:text-off-white text-xs font-semibold transition-all duration-200 cursor-pointer"
        >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <motion.div
          ...
          className="lg:col-span-7 bg-midnight-indigo rounded-3xl p-6 border border-hot-pink/10 shadow-[0_0_24px_rgba(0,0,0,0.15)] flex flex-col gap-6"
        >
          <div className="flex items-center justify-between pb-3 border-b border-white/5">
            <h3 className="text-xs font-sans font-bold text-off-white tracking-wider uppercase select-none flex items-center gap-2">
              <span className="w-2 h-2 rounded-full bg-hot-pink animate-pulse"></span>
              Visual Correspondence Frame
            </h3>
            <span className="font-mono text-[10px] text-lavender/70">Side-by-side verification</span>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            ...
            <div className="flex flex-col gap-2 group">
              <div className="aspect-[4/5] rounded-2xl overflow-hidden bg-deep-midnight border border-hot-pink/15 relative shadow-inner">
                <img
                ...
                <div className="absolute bottom-3 left-3 bg-deep-midnight/95 text-hot-pink border border-hot-pink/20 px-3 py-1 rounded-lg font-mono text-[10px] uppercase font-bold tracking-widest select-none">
                  YOUR IMAGE
                </div>
              </div>
              <div className="text-center sm:text-left">
                <p className="font-sans text-xs text-lavender font-semibold">Reference Image</p>
                <span className="font-sans text-[10px] text-lavender/60">Source query signature input</span>
              </div>
            </div>

            {/* Candidate Web Matched Frame (Matched Image) */}
            <div className="flex flex-col gap-2 group">
              <div className="aspect-[4/5] rounded-2xl overflow-hidden bg-deep-midnight border border-hot-pink/25 relative shadow-inner">
                <motion.img
                ...
                {/* Visual Label overlay */}
                <div className="absolute bottom-3 left-3 bg-deep-midnight/95 text-off-white border border-white/10 px-3 py-1 rounded-lg font-mono text-[10px] uppercase font-bold tracking-widest select-none">
                  MATCHED IMAGE
                </div>
              </div>
              <div className="text-center sm:text-left">
                <p className="font-sans text-xs text-hot-pink font-semibold">Matched Reference</p>
                <span className="font-sans text-[10px] text-lavender/60">Public internet node visual discovery</span>
              </div>
            </div>
        ...
        <div className="lg:col-span-5 space-y-6">
          ...
          <motion.div
            ...
            className="bg-midnight-indigo rounded-3xl p-6 border border-hot-pink/10 shadow-[0_0_24px_rgba(0,0,0,0.1)] flex flex-col gap-4"
          >
            <div className="flex items-center gap-5">
              ...
              <div className="relative w-16 h-16 flex items-center justify-center shrink-0">
                <svg className="w-16 h-16 transform -rotate-90">
                  ...
                  <circle 
                    className="text-hot-pink transition-all duration-1000 ease-out" 
                    cx="32" 
                    cy="32" 
                    fill="transparent" 
                    r="26" 
              ...
              <div>
                <span className="font-sans text-[10px] text-lavender/80 uppercase font-bold tracking-wider select-none block">
                  Similarity metric
                </span>
                <h4 className="font-sans text-xl font-bold text-off-white mt-0.5 leading-none">
                  Visual similarity
                </h4>
                <p className="text-hot-pink font-sans text-xs font-semibold mt-1 flex items-center gap-1.5 select-none">
          ...
          <motion.div
            variants={{ hidden: { opacity: 0, x: 12 }, visible: { opacity: 1, x: 0 } }}
            className="bg-midnight-indigo rounded-3xl p-6 border border-hot-pink/10 shadow-[0_0_24px_rgba(0,0,0,0.1)] space-y-4"
          >
            <div className="border-b border-white/5 pb-3">
              <span className="text-[10px] uppercase font-bold tracking-widest text-lavender/70 block">
                Source Metadata
              </span>
            ...
            <div className="space-y-4 pt-1">
              <div>
                <span className="text-[10px] uppercase font-bold tracking-widest text-lavender/60 block">
                  Source
                </span>
                <p className="text-sm font-sans text-off-white font-semibold mt-0.5">
              ...
              <div>
                ...
                <p className="text-sm font-sans text-off-white font-semibold mt-0.5 leading-snug">
              ...
              {(selectedResult.caption || selectedResult.description) && (
                <div>
                  ...
                  <p className="text-xs font-sans text-lavender italic mt-0.5 bg-deep-midnight/40 p-3 rounded-xl border border-hot-pink/5 leading-relaxed">
                    "{selectedResult.caption || selectedResult.description}"
                  </p>
                </div>
              )}
            ...
            <div className="pt-3 border-t border-white/5 flex items-center justify-between">
              <span className="text-[10px] text-lavender/60">External reference node</span>
              <a
                href={selectedResult.url}
                target="_blank"
                rel="noreferrer"
                className="group flex items-center gap-1 text-xs text-hot-pink font-sans font-bold hover:text-off-white transition-colors"
              >
          ...
          <motion.div
            variants={{ hidden: { opacity: 0, x: 12 }, visible: { opacity: 1, x: 0 } }}
            className="bg-midnight-indigo rounded-3xl p-6 border border-hot-pink/10 shadow-[0_0_24px_rgba(0,0,0,0.1)] space-y-3"
          >
            <h4 className="font-sans text-sm font-bold text-off-white select-none">
              Why this appears to match
            </h4>
            
            <ul className="space-y-2 text-xs text-lavender">
              <li className="flex items-start gap-2">
                <span className="text-hot-pink select-none font-bold text-sm leading-none">•</span>
            ...
            <div className="pt-2 mt-2 border-t border-white/5">
              <p className="text-[10px] text-lavender/70 leading-normal italic">
          ...
          <motion.div
            ...
            className="p-1 rounded-3xl bg-gradient-to-r from-hot-pink/20 to-coral/20 border border-hot-pink/15"
          >
            <div className="bg-deep-midnight rounded-[22px] p-5 text-center">
              ...
              <p className="font-sans text-xs text-lavender leading-relaxed mt-1 mb-4">
              ...
              <button
                ...
                className={`w-full py-3 rounded-xl font-sans text-xs font-bold transition-all flex items-center justify-center gap-2 border-0 cursor-pointer ${
                  isVerifying
                    ? "bg-deep-violet text-lavender/65 cursor-not-allowed"
              ...
              >
                {isVerifying ? (
                  <>
                    <svg className="animate-spin h-4 w-4 text-hot-pink" fill="none" viewBox="0 0 24 24">
